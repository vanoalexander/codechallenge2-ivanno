    ...
    return (
        <div>
            <div>
                ...
                <img className='w-1/2 m-auto border rounded-full' src='/company-building.jpg' alt='office' />
            ...
            <hr class="w-48 h-1 mx-auto my-4 border-0 rounded md:my-10 bg-gray-500"></hr>
            <div>
                ...
                <img className='w-1/2 m-auto border rounded-full' src='/office-bg.jpg' alt='culture' />
