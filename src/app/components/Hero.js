    ...
    return (
        <div className='h-screen bg-gradient-to-r from-blue-500 to-green-400 relative'>
            <div className='absolute z-10 left-14 top-32 lg:left-32 lg:top-52 font-bold text-white text-5xl m-8 w-1/2'>
                ...
                <button type="button" class="text-white font-semibold bg-gradient-to-r from-lime-300 via-lime-400 to-lime-500 hover:bg-gradient-to-br rounded-lg text-base px-5 py-3.5 text-center me-2 mb-2 mt-8">Find House</button>
            </div>
