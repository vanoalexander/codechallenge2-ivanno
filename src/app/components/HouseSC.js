        ...
        <div>
            ...
            <div className='m-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 py-8 px-12'>
                <div className='border rounded-lg hover:bg-green-600 hover:text-white hover:shadow-2xl'>
                    <div>
                        <img className='w-full h-2/3' src='/house1.jpg' />
                    </div>
                    <div className='m-5'>
                ...
                <div className='border rounded-lg hover:bg-green-600 hover:text-white hover:shadow-2xl'>
                    <div>
                        <img className='w-full h-2/3' src='/house2.jpg' />
                    </div>
                    <div className='m-5'>
                        <p className='text-2xl sm:text-xl md:text-2xl font-extrabold'>IDR 200.000.000,-</p>
                        <p className=' font-light font-serif text-sm'>Jl. Soekarno Hatta No.1</p>
                ...
                <div className='border rounded-lg hover:bg-green-600 hover:text-white hover:shadow-2xl'>
                    <div>
                        <img className='w-full h-2/3' src='/house3.jpg' />
                    </div>
                    <div className='m-5'>
                        <p className='text-2xl sm:text-xl md:text-2xl font-extrabold'>IDR 200.000.000,-</p>
                        <p className=' font-light font-serif text-sm'>Jl. Soekarno Hatta No.1</p>
                ...
                <div className='border rounded-lg hover:bg-green-600 hover:text-white hover:shadow-2xl'>
                    <div>
                        <img className='w-full h-2/3' src='/house4.jpg' />
                    </div>
                    <div className='m-5'>
                        <p className='text-2xl sm:text-xl md:text-2xl font-extrabold'>IDR 200.000.000,-</p>
                        <p className=' font-light font-serif text-sm'>Jl. Soekarno Hatta No.1</p>
                ...
                <div className='border rounded-lg hover:bg-green-600 hover:text-white hover:shadow-2xl'>
                    <div>
                        <img className='w-full h-2/3' src='/house5.jpg' />
                    </div>
                    <div className='m-5'>
                        <p className='text-2xl sm:text-xl md:text-2xl font-extrabold'>IDR 200.000.000,-</p>
                        <p className=' font-light font-serif text-sm'>Jl. Soekarno Hatta No.1</p>
                ...
                <div className='border rounded-lg hover:bg-green-600 hover:text-white hover:shadow-2xl'>
                    <div>
                        <img className='w-full h-2/3' src='/house6.jpg' />
                    </div>
                    <div className='m-5'>
                        <p className='text-2xl sm:text-xl md:text-2xl font-extrabold'>IDR 200.000.000,-</p>
                        <p className=' font-light font-serif text-sm'>Jl. Soekarno Hatta No.1</p>
